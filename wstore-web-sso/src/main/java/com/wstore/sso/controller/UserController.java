...
public class UserController {
    ...
    @Value("${verify_code.key}")
    private String VERIFY_CODE_KEY;

    @Value("${verify_code.timeout}")
    private Integer VERIFY_CODE_TIMEOUT;

    @Value("${sso.key}")
    private String USER_KEY;

    @Value("${sso.timeout}")
    private Long USER_TIMEOUT;
